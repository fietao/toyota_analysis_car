...
def verified(raw_series, powertrain):
    return {
        "canonical_brand": "ACME",
        "raw_series": raw_series,
        "canonical_series": "ALPHA",
        "powertrain": powertrain,
        "review_status": "verified",
        "evidence": "manufacturer specification",
        "reviewer": "admin",
        "reviewed_at": "2026-07-17T12:00:00+07:00",
    }


def test_model_tree_has_one_brand_and_registry_backed_series_segments():
    model = model_frame([
        {"\u0e22\u0e35\u0e48\u0e2b\u0e49\u0e2d\u0e23\u0e162": "ACME", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e16": "ALPHA ICE", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e162": "ALPHA", "Powertrain": "ICE", "\u0e08\u0e33\u0e19\u0e27\u0e19\u0e23\u0e16": 10},
        {"\u0e22\u0e35\u0e48\u0e2b\u0e49\u0e2d\u0e23\u0e162": "ACME", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e16": "ALPHA HEV", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e162": "ALPHA", "Powertrain": "HEV", "\u0e08\u0e33\u0e19\u0e27\u0e19\u0e23\u0e16": 7},
        {"\u0e22\u0e35\u0e48\u0e2b\u0e49\u0e2d\u0e23\u0e162": "ACME", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e162": "ALPHA", "Powertrain": None, "\u0e08\u0e33\u0e19\u0e27\u0e19\u0e23\u0e16": 3},
    ])
    ...
    assert {segment["powertrain"] for segment in series["segments"]} == {"ICE", "HEV", "N/A"}
    ...
    assert validate_public_model_tree(tree_payload(tree), [verified("ALPHA ICE", "ICE"), verified("ALPHA HEV", "HEV")]) == 1


def test_empty_registry_keeps_triton_wholly_in_na():
    model = model_frame([
        {"\u0e22\u0e35\u0e48\u0e2b\u0e49\u0e2d\u0e23\u0e162": "MITSUBISHI", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e162": "TRITON", "Powertrain": "N/A", "\u0e08\u0e33\u0e19\u0e27\u0e19\u0e23\u0e16": 100},
    ])
...
def test_validator_rejects_unapproved_or_unreconciled_segments():
    tree = build_brand_model_tree(model_frame([
        {"\u0e22\u0e35\u0e48\u0e2b\u0e49\u0e2d\u0e23\u0e162": "ACME", "\u0e23\u0e38\u0e48\u0e19\u0e23\u0e162": "ALPHA", "Powertrain": "HEV", "\u0e08\u0e33\u0e19\u0e27\u0e19\u0e23\u0e16": 7},
    ]))

    with pytest.raises(ValueError, match="not registry-approved"):
    ...
    with pytest.raises(ValueError, match="segments do not reconcile"):
        validate_public_model_tree(tree_payload(tree), [verified("ALPHA HEV", "HEV")])
